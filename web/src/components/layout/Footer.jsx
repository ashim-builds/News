...
const FOOTER_NAV = {
  ...
  "प्रदेश समाचार": [
    { label: "कोशी प्रदेश", href: "/province/koshi" },
    { label: "मधेश प्रदेश", href: "/province/madhesh" },
    { label: "बागमती प्रदेश", href: "/province/bagmati" },
    { label: "गण्डकी प्रदेश", href: "/province/gandaki" },
    { label: "लुम्बिनी प्रदेश", href: "/province/lumbini" },
    { label: "कर्णाली प्रदेश", href: "/province/karnali" },
    { label: "सुदूरपश्चिम", href: "/province/sudurpashchim" },
  ],
  "नेभिगेसन": [
