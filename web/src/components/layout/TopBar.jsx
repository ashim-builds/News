    ...
    <div className="w-full bg-gray-100 border-b border-gray-200">
      <div className="container mx-auto flex items-center justify-between min-h-9 py-1 px-4 gap-3">
        ...
        <div className="shrink-0 hidden md:flex items-center gap-3">
          ...
          <a href="#" aria-label="X" className="text-gray-400 hover:text-gray-900 transition">
          ...
          <a href="#" aria-label="Instagram" className="text-gray-400 hover:text-pink-600 transition">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-3.5 h-3.5"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="0.5" fill="currentColor" stroke="none" /></svg>
          </a>
        </div>
      </div>
    </div>
